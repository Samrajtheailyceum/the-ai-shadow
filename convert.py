...
<div style="margin-top: 40px; padding: 28px; background: var(--color-bg-alt); border: 1px solid var(--color-divider-light);">
  <h2 style="font-family: var(--font-sans); font-size: 0.8rem; letter-spacing: 0.2em; text-transform: uppercase; color: var(--color-accent); margin-bottom: 16px; border: none; padding: 0; margin-top: 0;">Editorial Disclaimer</h2>
  <p style="font-size: 0.88rem; line-height: 1.65; color: var(--color-text-light); margin-bottom: 12px;">The AI Lyceum&reg; publishes this work as philosophical research and creative scholarship. It is offered in the spirit of open intellectual inquiry.</p>
  <p style="font-size: 0.88rem; line-height: 1.65; color: var(--color-text-light); margin-bottom: 12px;">The AI Lyceum&reg; does not endorse, affirm, or adopt any of the philosophical positions, arguments, or conclusions expressed in this dialogue. The views attributed to Sigmund Freud and Carl Gustav Jung are creative reconstructions of their respective psychoanalytic and analytical-psychological positions applied to contemporary questions about AI &mdash; not the opinions of The AI Lyceum&reg;, its contributors, or any third party.</p>
  <p style="font-size: 0.88rem; line-height: 1.65; color: var(--color-text-light); margin-bottom: 12px;"><strong>Independence and non-affiliation.</strong> This publication is an independent work by Samraj Matharu, published under The AI Lyceum&reg;. It is not affiliated with, sponsored by, endorsed by, or representative of Anthropic, PBC, OpenAI, Google DeepMind, or any other AI company, research laboratory, university, or organisation. The use of Anthropic&rsquo;s Claude model as a generation tool does not imply any association with, approval by, or endorsement from Anthropic.</p>
  <p style="font-size: 0.88rem; line-height: 1.65; color: var(--color-text-light); margin-bottom: 12px;"><strong>No liability.</strong> This work is provided on an &ldquo;as-is&rdquo; basis for educational and research purposes only. The author and The AI Lyceum&reg; accept no liability for any loss, damage, or consequence arising from the use of, reliance on, or interpretation of any content in this publication. AI-generated text may contain inaccuracies, hallucinations, or misrepresentations of philosophical positions. Readers should verify all claims independently.</p>
  <p style="font-size: 0.88rem; line-height: 1.65; color: var(--color-text-light); margin-bottom: 12px;">Nothing in this publication constitutes professional advice on artificial intelligence policy, ethics, regulation, law, psychology, or deployment.</p>
  <p style="font-size: 0.88rem; line-height: 1.65; color: var(--color-text-light); margin-bottom: 12px;"><strong>Intellectual property.</strong> &copy; 2026 Samraj Matharu. All rights reserved. &ldquo;The AI Lyceum&rdquo;&reg; is a registered trademark of Samraj Matharu. &ldquo;The AI Shadow&rdquo;&trade;, &ldquo;The AI Republic: A Dialogue&rdquo;&trade;, and &ldquo;The Lyceum Method&rdquo;&trade; are trademarks of Samraj Matharu.</p>
  <p style="font-size: 0.88rem; line-height: 1.65; color: var(--color-text-light);"><strong>Contact.</strong> Anthropic, rights holders, or any other interested parties with questions, licensing enquiries, or concerns about this publication may contact the author at <a href="mailto:hello@theailyceum.com">hello@theailyceum.com</a>.</p>
</div>
